...
//! 对应 tauri-bridge.ts 的 `worldCardApi`（世界观资料库独立窗口）。
...
/// 创建世界观卡片，初始未向量化
#[tauri::command]
pub async fn create_world_card(
    app: AppHandle,
    db: State<'_, AppDb>,
    params: CreateWorldCardParams,
...
/// 删除世界观卡片
#[tauri::command]
pub async fn delete_world_card(
    app: AppHandle,
    db: State<'_, AppDb>,
    id: String,
) -> Result<(), AppError> {
