...
| [📤 导入导出与备份](user-guide/import-export) | 导入预览、指纹校验、幂等去重、错误码（v1.7.0 重构） |
...
| 样式 | TailwindCSS 4 + HSL CSS 变量（3 基础主题 × 2 护眼模式 = 6 套配色） |
| 富文本 | TipTap |
| 状态管理 | Zustand（8 个领域 store）+ Jotai（23 个 atom，含 toast） |
